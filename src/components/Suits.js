...
function Suits() {
  const suits = [
    {img: "https://www.figma.com/file/5kApz6MuwIO15ml8UVs5In/image/c9d1b1222676416bf68677f5b7dbb6f629295b08",
     priceLeft: {cost: "1 899 ₴", top: "20%", left: "12%"}, priceRight: {cost: "899 ₴", top: "60%", left: "55%"}},
    {img: "https://www.figma.com/file/5kApz6MuwIO15ml8UVs5In/image/81ef103c55fb161c0a22e565f4af829cadb90093",
    priceLeft: {cost: "1 899 ₴", top: "50%", left: "10%"}, priceRight: {cost: "899 ₴", top: "20%", left: "60%"}},
    {img: "https://www.figma.com/file/5kApz6MuwIO15ml8UVs5In/image/0e7010878fedabf31e6d8ca8e91b715db4ea89c4",
    priceLeft: {cost: "1 899 ₴", top: "30%", left: "10%"}, priceRight: {cost: "899 ₴", top: "60%", left: "70%"}},
    {img: "https://www.figma.com/file/5kApz6MuwIO15ml8UVs5In/image/796ab860adfaad961808d739b115492cca4406eb",
          ...
          <div className="price-container" style={{top: item.priceLeft.top || 0, left: item.priceLeft.left || 0}}>
            <div className="price">
              <svg width="105" height="67" viewBox="0 0 105 67" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M99 0H9V3H6V6H3V9H0V44H3V47H6V50H64V55H67V58H70V61H73V64H80V67H83V64H80V61H83V54H86V51H96V48H99V45H102V42H105V6H102V3H99V0ZM99 3V6H102V42H99V45H96V48H86V51H83V54H80V61H73V58H70V55H67V50H64V47H6V44H3V9H6V6H9V3H99Z" fill="#1F1F1F"/>
              </svg>
          ...
          <div className="price-container" style={{top: item.priceRight.top || 0, left: item.priceRight.left || 0}}>
            <div className="price">
              <svg width="105" height="67" viewBox="0 0 105 67" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M6 0H96V3H99V6H102V9H105V44H102V47H99V50H41V55H38V58H35V61H32V64H25V67H22V64H25V61H22V54H19V51H9V48H6V45H3V42H0V6H3V3H6V0ZM6 3V6H3V42H6V45H9V48H19V51H22V54H25V61H32V58H35V55H38V50H41V47H99V44H102V9H99V6H96V3H6Z" fill="#1F1F1F"/>
              </svg>
